    ...
    public partial class Form1 : Form
     {
        ...
        private void input2TextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                byte2 = Convert.ToByte(input1TextBox.Text);
            ...
            try
            {
                sbyte2 = Convert.ToSByte(input1TextBox.Text);
            ...
            try
            {
                short2 = Convert.ToInt16(input1TextBox.Text);
            ...
            try
            {
                ushort2 = Convert.ToUInt16(input1TextBox.Text);
            ...
            try
            {
                int2 = Convert.ToInt32(input1TextBox.Text);
            ...
            try
            {
                uint2 = Convert.ToUInt32(input1TextBox.Text);
            ...
            try
            {
                long2 = Convert.ToInt64(input1TextBox.Text);
            ...
            try
            {
                ulong2 = Convert.ToUInt64(input1TextBox.Text);
            ...
            try
            {
                double2 = Convert.ToDouble(input1TextBox.Text);
            ...
            try
            {
                decimal2 = Convert.ToDecimal(input1TextBox.Text);
